...
- [x] **1. Petakan suasana → animasi** — tiap tema aplikasi diberi `ambientFx`
...
- [x] **2. Komponen efek ambien** — buat komponen ringan `AmbientFx` (mirip
...
- [x] **3. Wire ke ScreenFade** — `ScreenFade` merender `AmbientFx` sesuai
  ...
  dobel/berat).
- [x] **4. Performa & verifikasi** — pastikan native driver, tanpa re-render
