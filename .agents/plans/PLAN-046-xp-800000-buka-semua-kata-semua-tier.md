...
- [ ] **1. Konstanta & logika unlock** — tambah `UNLOCK_ALL_TIERS_XP = 800000`
  di `xpEngine.ts` + helper (mis. `shouldUnlockAllTiers(totalXp)`).
- [ ] **2. Repository dukung semua tier** — `vocabularyRepository` method
