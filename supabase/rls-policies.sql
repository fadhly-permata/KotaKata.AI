...
--   1) supabase/fix-user-tables.sql        (id string → text; tanpa ini semua
--      sync gagal karena kolom masih uuid)
--   2) supabase/fix-word-discoveries.sql   (word_discoveries jadi FK-only)
--   3) supabase/vocabulary.sql             (isi tabel vocabulary)
