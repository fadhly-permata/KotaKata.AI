...
import { applySoundPrefsFromCloud } from "../../utils/sound";
import { useThemeSelectionStore, markThemeHydrated } from "../stores/themeSelectionStore";
    ...
    const {
      ...
      (async () => {
        try {
          ...
          // Sinkronkan preferensi user dari cloud ke in-memory state.
          ...
          try {
            ...
            if (prefs.app_theme_id) {
              useThemeSelectionStore.getState().setAppThemeId(prefs.app_theme_id);
            }
            // Sound & ambient: apply ke in-memory state
            applySoundPrefsFromCloud(prefs.sound_enabled, prefs.ambient_enabled);
            // Mark hydrated
            markThemeHydrated();
          } catch (err) {
